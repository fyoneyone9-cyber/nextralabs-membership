  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-10 space-y-10 min-h-screen text-slate-200 bg-[#050507] border-4 border-emerald-500/50 rounded-[4rem]">
      <div className="text-center space-y-2">
        <Badge className="bg-emerald-600 text-white font-black italic px-4 py-1 text-[10px] uppercase rounded-full">Evidence Security OS</Badge>
        <h1 className="text-4xl md:text-6xl font-black text-white uppercase italic text-center">エビデンスAIマネージャー</h1>
      </div>
      <Card className="bg-[#13141f] p-10 rounded-[3rem] text-center space-y-8">
        ...
        <h3 className="text-3xl text-white font-black italic mb-6 uppercase text-center">サブスク実績の証拠管理・クリーンアップ</h3>
        ...
        <button onClick={runCleanup} disabled={isProcessing} className="h-20 px-12 bg-emerald-600 text-white font-black rounded-2xl shadow-xl hover:bg-emerald-500 transition-all uppercase italic flex items-center justify-center gap-4 mx-auto">
