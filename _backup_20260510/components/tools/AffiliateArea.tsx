  ...
  return (
    <div className="space-y-6 mt-12 mb-10">
      <div className="flex items-center justify-center gap-3">
        ...
        <Badge variant="outline" className="text-emerald-500 border-emerald-500/30 font-black uppercase text-[10px] tracking-widest px-4 py-1">NextraLabs Select</Badge>
        <div className="h-px w-10 bg-emerald-500/30"></div>
      </div>
      <h4 className="text-xl md:text-2xl font-black text-white italic uppercase tracking-tighter text-center">このツールに関連するおすすめアイテム</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
        <a href="https://amzn.to/3WxXh9C" target="_blank" rel="noopener noreferrer" className="group block">
          <Card className="bg-[#13141f] border-2 border-white/5 hover:border-emerald-500/50 transition-all rounded-[1.5rem] p-5 text-left flex items-center gap-4 shadow-xl relative overflow-hidden">
            <div className="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center shrink-0 border border-white/10 group-hover:bg-emerald-500/10 transition-colors">
              <ShoppingBag className="text-slate-500 group-hover:text-emerald-500" size={24} />
            </div>
            <div className="space-y-0.5">
              <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest italic">Must Have</p>
        ...
        <a href="https://amzn.to/3WxXh9C" target="_blank" rel="noopener noreferrer" className="group block">
          <Card className="bg-[#13141f] border-2 border-white/5 hover:border-emerald-500/50 transition-all rounded-[1.5rem] p-5 text-left flex items-center gap-4 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-0.5">
              <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest italic">AI Essential</p>
