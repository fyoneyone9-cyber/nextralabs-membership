    ...
    <div className="min-h-screen bg-[#050507] text-slate-100 p-4 md:p-12 font-sans">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center gap-4 border-b border-emerald-500/20 pb-8">
          ...
          <div>
            <h1 className="text-4xl font-black italic uppercase tracking-tighter text-white">Identity Console</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <Card className="bg-[#13141f] border-2 border-white/5 rounded-[2rem] p-8 flex flex-col items-center text-center space-y-6">
            ...
            <Card className="bg-emerald-500/10 border-2 border-emerald-500 rounded-[2rem] p-6 text-center shadow-[0_0_30px_rgba(16,185,129,0.2)]">
              ...
              <p className="text-[8px] text-emerald-500/50 font-bold uppercase mt-1">Cost Avoidance Value</p>
            </Card>
          </div>
          ...
          <div className="md:col-span-2 space-y-6">
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full h-14 bg-black border-2 border-white/10 rounded-xl px-6 text-lg font-black text-white focus:border-emerald-500 outline-none transition-all shadow-inner"
                  />
                </div>
            ...
            <Card className="bg-[#13141f] border-2 border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl">
              ...
              <CardContent className="p-8 space-y-4">
                ...
                <div className="flex justify-between items-center bg-black/40 p-4 rounded-xl border border-white/5">
                  <span className="text-xs font-bold text-slate-500 uppercase">次回更新日</span>
