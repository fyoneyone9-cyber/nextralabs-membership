...
export default async function DashboardPage() {
  ...
  const quickTools = [
    ...
    { id: 'contact-sync', name: 'AI Contact Sync', icon: Users, color: 'text-indigo-400', bg: 'bg-indigo-400/10', isModel: true },
    { id: 'interior-coordinator', name: 'AI Interior Sync', icon: Sofa, color: 'text-amber-500', bg: 'bg-amber-500/10', isModel: true },
