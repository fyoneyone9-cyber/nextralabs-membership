    ...
    <div className="min-h-screen bg-[#050507] flex items-center justify-center px-4 py-10 font-sans">
      <Card className="w-full max-w-md bg-[#13141f] border border-emerald-500/20 rounded-3xl shadow-[0_0_60px_rgba(16,185,129,0.08)]">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold uppercase tracking-tight text-white">新しいパスワードを設定</CardTitle>
        ...
        <CardContent>
          {!ready ? (
            <div className="text-center space-y-4">
              ...
              <Button className="w-full h-12 border-2 border-emerald-500/40 text-emerald-400 font-bold rounded-2xl hover:border-emerald-400 bg-transparent transition-all mt-2" onClick={() => router.push('/forgot-password')}>
                リセットリンクを再送信
              </Button>
            </div>
          ) : (
            <form onSubmit={handleUpdate} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="password" className="text-xs font-bold uppercase tracking-tight text-emerald-400">新しいパスワード</Label>
                <Input
                  id="password"
                  type="password"
                  placeholder="6文字以上"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-tight text-emerald-400">パスワード確認</Label>
                <Input
                  id="confirmPassword"
                  type="password"
                  placeholder="もう一度入力"
