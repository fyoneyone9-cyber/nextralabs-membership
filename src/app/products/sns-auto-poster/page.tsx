  ...
  return (
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-32">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-24 pb-20 text-center space-y-10">
        <Badge className="bg-rose-500/10 text-rose-400 border-rose-500/20 px-6 py-1 rounded-full font-black uppercase text-xs tracking-widest">SNSバズ量産エンジン</Badge>
      ...
      <section className="bg-[#13141f] py-24 border-y border-white/5 text-left">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-black/50 border-4 border-rose-500/20 rounded-[3rem] p-10 shadow-inner text-center">
             <p className="text-rose-400 text-lg italic font-black leading-loose text-center">
      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20 text-left">
        <div className="text-center space-y-4">
          <h3 className="text-4xl md:text-5xl font-black text-white italic uppercase tracking-tighter text-center">インプレッションを支配する技術</h3>
          <p className="text-slate-500 font-bold uppercase italic text-center">SNSの影響力を最大化する4つの武器</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-black text-white uppercase italic">10種のバズ戦略パレット</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-black text-white uppercase italic text-left text-left">AIバズ期待度計測</h4>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 text-center">
        <Card className="bg-gradient-to-br from-rose-600 to-red-900 border-0 rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden text-center space-y-10">
          ...
          <div className="relative z-10 space-y-6 text-center">
            <h3 className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tighter leading-none">影響力の、新次元へ。</h3>
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-6 text-center">
              <Link href="/signup">
                <button className="h-20 px-16 bg-white text-rose-700 font-black text-2xl rounded-2xl shadow-xl hover:bg-rose-50 transition-all active:scale-95 uppercase italic leading-none">
                  無料で始めてみる
                </button>
              </Link>
            </div>
