  ...
  return (
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-32">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-24 pb-20 text-center space-y-10">
        <Badge className="bg-rose-500/10 text-rose-400 border-rose-500/20 px-6 py-1 rounded-full font-bold text-xs tracking-tight">SNSバズ量産エンジン</Badge>
        <h1 className="text-5xl md:text-8xl font-bold text-white tracking-tighter leading-[1.1]">
          SNS <span className="text-rose-500">自動</span>投稿AI
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-6 pt-6">
          <Link href="/products/sns-auto-poster/app">
            <button className="h-20 px-12 bg-rose-600 hover:bg-rose-500 text-white font-bold text-xl rounded-2xl shadow-[0_20px_50px_rgba(225,29,72,0.3)] transition-all active:scale-95 leading-none">
              最強の投稿を作る ➔
            </button>
          </Link>
        </div>
        ...
        {/* YouTube動画埋め込み */}
        <div className="w-full max-w-3xl mx-auto mt-10 rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(225,29,72,0.2)] border border-white/10">
          <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
            <iframe
              className="absolute inset-0 w-full h-full"
              src="https://www.youtube.com/embed/D1pG7NhXeC8?rel=0&modestbranding=1"
              title="SNS自動投稿AI 紹介動画"
      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20 text-left">
        <div className="text-center space-y-4">
          <h3 className="text-4xl md:text-5xl font-bold text-white tracking-tighter text-center">インプレッションを支配する技術</h3>
          <p className="text-slate-500 font-bold text-center">SNSの影響力を最大化する4つの武器</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left">
            ...
            <h4 className="text-xl font-bold text-white">リアルタイム・トピックス</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-bold text-white">10種のバズ戦略パレット</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-bold text-white text-left">マルチ媒体一括生成</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-bold text-white text-left">結婚相談所特化モード</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-rose-500/30 transition-all group text-left text-left">
            ...
            <h4 className="text-xl font-bold text-white text-left">AIバズ期待度計測</h4>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 text-center">
        <Card className="bg-gradient-to-br from-rose-600 to-red-900 border-0 rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden text-center space-y-10">
          ...
          <div className="relative z-10 space-y-6 text-center">
            <h3 className="text-4xl md:text-6xl font-bold text-white tracking-tighter leading-none">影響力の、新次元へ。</h3>
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-6 text-center">
              <Link href="/signup">
                <button className="h-20 px-16 bg-white text-rose-700 font-bold text-2xl rounded-2xl shadow-xl hover:bg-rose-50 transition-all active:scale-95 leading-none">
                  無料で始めてみる
                </button>
              </Link>
            </div>
