  ...
  return (
    <div>
      ...
      <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-6 mb-12 text-center">
        <p className="text-sm text-muted-foreground mb-3">🛒 家計管理・節約本をAmazonでチェック</p>
        <a
          href="https://www.amazon.co.jp/s?k=%E5%AE%B6%E8%A8%88%E7%AE%A1%E7%90%86%20%E7%AF%80%E7%B4%84&tag=nextralabs-22"
          target="_blank"
