      ...
      <div className="min-h-screen" style={{ background: '#050507', fontFamily: "'Inter', 'Noto Sans JP', sans-serif", color: '#f1f5f9' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 pb-8">
          <div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between gap-3">
            <p className="text-xs text-slate-500 truncate">?????????????Amazon?????</p>
            <a href="/products/travel-concierge/app" target="_blank" rel="noopener noreferrer sponsored" className="shrink-0 inline-flex items-center gap-1.5 text-[11px] font-medium text-slate-400 hover:text-amber-400 transition-colors">
