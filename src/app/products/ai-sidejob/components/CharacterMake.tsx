...
export const CharacterMake: React.FC<CharacterMakeProps> = ({ onComplete, isSubmitting }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto border-4 border-emerald-500 rounded-[3rem] p-8 md:p-12 bg-[#0a0a0c] shadow-[0_0_50px_rgba(16,185,129,0.3)] relative overflow-hidden">
      {/* MASTER品質の証 */}
