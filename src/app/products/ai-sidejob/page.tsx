  ...
  return (
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-32">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-24 pb-20 text-center space-y-10">
        <Badge className="bg-[#5845e0]/10 text-[#5845e0] border-[#5845e0]/20 px-6 py-1 rounded-full font-black uppercase text-xs tracking-widest">副業自動化支援システム</Badge>
      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20 text-left">
        <div className="text-center space-y-4">
          <h3 className="text-4xl md:text-5xl font-black text-white italic uppercase tracking-tighter">収益化のための4つの知能</h3>
          <p className="text-slate-500 font-bold uppercase italic text-center">稼ぐ力を最大化するテクノロジー</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 text-left">
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-[#5845e0]/30 transition-all group">
            ...
            <h4 className="text-xl font-black text-white uppercase italic">0→1手順書の自動錬成</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-[#5845e0]/30 transition-all group">
            ...
            <h4 className="text-xl font-black text-white uppercase italic">防御のためのマネー知識</h4>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 text-center">
        <Card className="bg-gradient-to-br from-[#5845e0] to-[#2d1b94] border-0 rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden text-center space-y-10">
          ...
          <div className="relative z-10 space-y-6 text-center">
            <h3 className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tighter">新しいキャリアを、今。</h3>
            <p className="text-indigo-100 text-lg font-bold leading-relaxed max-w-2xl mx-auto px-4 text-center">
