    ...
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-20">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/products/ai-recipe/app" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto h-12 px-10 bg-emerald-600 hover:bg-emerald-500 text-slate-950 font-bold text-xl rounded-2xl shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all">
              ...
              <div className="relative bg-[#0a0a0f] border-2 border-emerald-500 rounded-[2rem] p-6 md:p-12 shadow-2xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="space-y-8">
                    ...
                    <h2 className="text-3xl font-bold text-white tracking-tight uppercase leading-tight">
                      食材を無駄にしない <br />
                      究極のキッチン・アシスト
                    </h2>
                  ...
                  <div className="bg-[#13141f] rounded-3xl p-6 border border-white/5 shadow-inner">
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white font-bold text-xs uppercase tracking-tight">Recipe Preview</span>
                      </div>
                    ...
                    <div className="space-y-4">
                      <Link href="/products/ai-recipe/app" className="block group/cam">
                        <div className="aspect-video bg-black/40 rounded-2xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-2 group-hover/cam:border-emerald-500/50 group-hover/cam:bg-emerald-500/5 transition-all">
                          ...
                          <span className="text-[10px] text-slate-600 font-bold uppercase group-hover/cam:text-emerald-400">Launch Camera & Analyze</span>
                        </div>
                      </Link>
                      ...
                      <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                        <div className="text-[10px] text-emerald-500 font-bold ">PROPOSED: 豚肉と白菜の重ね蒸し</div>
      ...
      <section className="py-20 bg-emerald-500/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 uppercase">「何作ろう？」を、0秒に。</h2>
          ...
          <Link href="/products/ai-recipe/app">
            <Button className="h-12 px-12 bg-white text-slate-950 font-bold text-xl rounded-2xl hover:bg-slate-200 transition-all">
              無料で体験する
            </Button>
          </Link>
