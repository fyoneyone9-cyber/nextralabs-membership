  ...
  return (
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-32">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-24 pb-20 text-center space-y-10 text-left">
        <Badge className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 px-6 py-1 rounded-full font-bold uppercase text-xs tracking-tight">Financial Automation OS</Badge>
      ...
      <section className="bg-[#13141f] py-24 border-y border-white/5 text-left">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h3 className="text-3xl font-bold text-white uppercase tracking-tight">領収書の山に、毎月悩んでいませんか？</h3>
          ...
          <div className="bg-black/50 border-4 border-emerald-500/20 rounded-[3rem] p-10 shadow-inner text-center">
             <p className="text-emerald-400 text-lg font-bold leading-loose">
      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20 text-left">
        <div className="text-center space-y-4">
          <h3 className="text-4xl md:text-5xl font-bold text-white uppercase tracking-tighter text-center">Ledger Intelligence</h3>
          <p className="text-slate-500 font-bold uppercase text-center">自動化を支える4つのマスタ機能</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-emerald-500/30 transition-all group">
            ...
            <h4 className="text-xl font-bold text-white uppercase ">AIレシート鑑定</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-emerald-500/30 transition-all group">
            ...
            <h4 className="text-xl font-bold text-white uppercase ">スプレッドシート完全同期</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-emerald-500/30 transition-all group">
            ...
            <h4 className="text-xl font-bold text-white uppercase ">Expenses フォルダ監視</h4>
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 hover:border-emerald-500/30 transition-all group">
            ...
            <h4 className="text-xl font-bold text-white uppercase ">爆速処理エンジン</h4>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 text-center">
        <Card className="bg-gradient-to-br from-emerald-600 to-teal-900 border-0 rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden text-center space-y-10">
          ...
          <div className="relative z-10 space-y-6 text-center">
            <h3 className="text-4xl md:text-6xl font-bold text-white uppercase tracking-tighter">Automate Your Ledger.</h3>
