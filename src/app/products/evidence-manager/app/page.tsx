      ...
      <div className="max-w-5xl mx-auto space-y-10 border-4 border-emerald-500 shadow-[0_0_100px_rgba(16,185,129,0.2)] rounded-[3rem] p-6 md:p-12 text-white font-black">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-emerald-500/20 pb-10">
          ...
          <div className="flex flex-col items-end gap-2">
            <Badge className="bg-emerald-500 text-slate-950 font-black italic px-6 py-2 text-sm rounded-full shadow-lg shadow-emerald-500/20">FREE PLAN</Badge>
            <ApiLinkIndicator model="Edge Archive Search" />
          </div>
        </div>
        ...
        <Card className="bg-[#13141f] border border-white/10 rounded-2xl p-8 text-center space-y-6 shadow-xl relative group">
          <div className="w-full h-48 bg-black/40 border-2 border-dashed border-white/10 rounded-2xl flex items-center justify-center cursor-pointer hover:border-emerald-500/50 transition-all">
             ...
             <div className="space-y-2 pointer-events-none text-center">
                <FileSearch className="h-12 w-12 text-slate-600 mx-auto" />
                <p className="text-slate-500 font-bold uppercase italic">証拠ファイルを添付</p>
             </div>
          </div>
