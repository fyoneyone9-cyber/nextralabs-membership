...
const TOOLS = [
  { id: 'staysee-ai-finder', cat: 'hotel', title: 'Nextra', sub: '宿泊予約・鍵発行を完全同期', icon: Building2, plan: 'プレミアム' },
      ...
      <CardContent className="p-5 md:p-6 flex flex-col h-full text-left relative z-10">
        ...
        <div className="pt-4 border-t border-white/5 flex flex-col gap-2.5 mt-auto">
          <Link href={"/products/" + product.id + "/app"} className="block w-full">
            <Button className="w-full h-10 md:h-12 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-sm md:text-base rounded-xl shadow-lg uppercase tracking-tighter">このツールを起動</Button>
          </Link>
