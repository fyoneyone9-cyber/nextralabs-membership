...
const bizTools: Product[] = [
  { id: 'pr-command', title: 'PR COMMAND', subtitle: '実績からの全自動PR記事生成', description: 'マスタ機が積み上げた「本物の証拠」を元に、note向けの最強PR記事を自動生成。投稿予約機能で、広報戦略を完全自動化します。', priceNote: 'スタンダード', tags: ['広報'], icon: Rocket, bgColor: 'bg-blue-500/10', iconColor: 'text-blue-400', status: 'NEW', isModel: true },
