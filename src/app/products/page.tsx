...
import { 
  ...
  Sprout, Zap, Droplets, Utensils, Building2, Hotel, Key, type LucideIcon, Lock, CreditCard, Coins, Sparkles, Archive, UserPlus, Table, Sofa, Play, TrendingUp, LineChart
} from 'lucide-react'
...
const bizTools: Product[] = [
  { id: 'trend-stock', title: 'SNSトレンド自動仕入れ', subtitle: 'バズ予測 × 楽天商品検索OS', description: 'Google TrendsとSNSのバイブスをAIが解析。「明日バズる」商品を予測し、楽天市場の在庫データと即座に同期して仕入れをサポートします。', priceNote: 'スタンダード', tags: ['物販'], icon: TrendingUp, bgColor: 'bg-orange-500/10', iconColor: 'text-orange-400', status: 'NEW', isModel: true },
