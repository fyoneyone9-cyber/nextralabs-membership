  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/50">
      ...
      <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-6 mb-12 text-center">
        <p className="text-sm text-muted-foreground mb-3">🛒 音楽・ライブグッズをAmazonでチェック</p>
        <a
          href="https://www.amazon.co.jp/s?k=%E3%83%81%E3%82%B1%E3%83%83%E3%83%88%20%E9%9F%B3%E6%A5%BD%20%E3%83%A9%E3%82%A4%E3%83%96&tag=nextralabs-22"
          target="_blank"
