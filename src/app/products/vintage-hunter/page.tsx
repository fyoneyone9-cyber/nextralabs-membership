  ...
  return (
    <div>
      ...
      <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-6 mb-12 text-center">
        <p className="text-sm text-muted-foreground mb-3">🛒 古着・ヴィンテージをAmazonでチェック</p>
        <a
          href="https://www.amazon.co.jp/s?k=%E5%8F%A4%E7%9D%80%20%E3%83%B4%E3%82%A3%E3%83%B3%E3%83%86%E3%83%BC%E3%82%B8&tag=nextralabs-22"
          target="_blank"
