      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20 text-left">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-6 hover:border-emerald-500/30 transition-all shadow-xl group">
            <div className="w-16 h-16 bg-emerald-600/10 rounded-2xl flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform"><Camera size={32} /></div>
            <h4 className="text-2xl font-black text-white italic uppercase">AIプロ鑑定</h4>
            <p className="text-slate-400 font-bold leading-relaxed text-sm">カメラで映すだけ。AIが物品の種類、ブランド、状態ランクを詳細に言語化。誰でもプロの鑑定が可能に。</p>
          </div>
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-6 hover:border-emerald-500/30 transition-all shadow-xl group">
          ...
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-6 hover:border-emerald-500/30 transition-all shadow-xl group">
            ...
            <h4 className="text-2xl font-black text-white italic uppercase">AI保管証明書</h4>
            <p className="text-slate-400 font-bold leading-relaxed text-sm">公式な管理番号付きの鑑定書を自動発行。宿泊者へ送付することで、圧倒的な信頼と安心感を提供します。</p>
          </div>
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-6 hover:border-emerald-500/30 transition-all shadow-xl group">
            <div className="w-16 h-16 bg-emerald-600/10 rounded-2xl flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform"><Zap size={32} /></div>
            <h4 className="text-2xl font-black text-white italic uppercase">収益化エンジン</h4>
            <p className="text-slate-400 font-bold leading-relaxed text-sm">AIが送料や手数料を自動算出。さらに返送荷物へのお土産同梱（アップセル）までAIが提案します。</p>
          </div>
        </div>
      </section>
