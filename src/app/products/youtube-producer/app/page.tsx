...
import { Zap, Loader2, CheckCircle2, TrendingUp, Search, Info, ShoppingCart, Clapperboard, FileText, Sparkles, Music } from 'lucide-react'
      ...
      <div className="max-w-5xl mx-auto space-y-10 border-4 border-emerald-500 shadow-[0_0_100px_rgba(16,185,129,0.2)] rounded-[3rem] p-6 md:p-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-emerald-500/20 pb-10">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter text-white">AI YouTubeプロデューサー</h1>
          </div>
