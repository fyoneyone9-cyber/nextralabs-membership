  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-6 mb-12 text-center">
        <p className="text-sm text-muted-foreground mb-3">🛒 仕事術・時短本をAmazonでチェック</p>
        <a
          href="https://www.amazon.co.jp/s?k=%E4%BB%95%E4%BA%8B%E8%A1%93%20%E6%99%82%E7%9F%AD&tag=nextralabs-22"
          target="_blank"
