  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">第2条（定義）</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">第3条（アカウント登録）</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">第6条（ツールの利用）</h2>
          <ol className="list-decimal pl-5 text-muted-foreground space-y-1">
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">第7条（知的財産権）</h2>
          <ol className="list-decimal pl-5 text-muted-foreground space-y-1">
        ...
        <section>
          <h2 className="text-xl font-bold mb-3">第8条（免責事項）</h2>
          <ol className="list-decimal pl-5 text-muted-foreground space-y-1">
        ...
        <section className="border-t pt-6">
          <h2 className="text-xl font-bold mb-3">運営者情報</h2>
