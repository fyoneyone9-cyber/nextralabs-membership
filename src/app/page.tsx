    ...
    <div className="animate-in fade-in duration-700 bg-[#050507] text-slate-200 min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden pt-16 pb-12 md:pt-32 md:pb-24 bg-slate-950 text-center">
        <div className="container mx-auto px-6 relative">
          ...
          <Link href="/products" className="inline-block"><Button size="lg" className="px-10 h-20 bg-emerald-500 text-slate-950 font-black rounded-2xl text-2xl md:text-4xl uppercase italic tracking-tighter shadow-[0_0_50px_rgba(16,185,129,0.4)] transition-transform hover:scale-105 active:scale-95">🔥 ツール一覧を見る</Button></Link>
        </div>
      </section>
