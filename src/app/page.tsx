    ...
    <div className="animate-in fade-in duration-700 bg-[#050507] text-slate-200 min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden pt-16 pb-12 md:pt-32 md:pb-24 bg-slate-950 text-center">
        <div className="container mx-auto px-6 relative">
          <Badge variant="outline" className="px-3 py-0.5 text-[10px] font-black text-emerald-500 border-emerald-500/20 uppercase mb-6">Nextra AILabs AIプラットフォーム</Badge>
      ...
      <div className="text-center opacity-30 text-[9px] font-black uppercase tracking-[0.3em] py-6 text-slate-400">Nextra AILabs マスタモデル • 2026</div>
