  ...
  return (
    <div className="animate-in fade-in duration-700 bg-[#050507] text-slate-200 min-h-screen flex flex-col">
      ...
      <section className="py-12 bg-[#050507]">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-3 mb-6 text-white border-l-8 border-emerald-500 pl-4 py-1"><Hotel className="h-6 w-6 text-emerald-500" /><h2 className="text-xl md:text-4xl font-black">ホテルDX</h2></div>
          <Link href="/products/nextra-ai">
            <Card className="border-2 border-emerald-500/30 bg-[#13141f] text-white rounded-[2rem] shadow-2xl">
              <CardContent className="p-8 space-y-6">
                ...
                <h3 className="text-2xl md:text-4xl font-black leading-none">Nextra AI <span className="text-emerald-400">ホテルDX</span></h3>
                <p className="text-slate-400 text-xs md:text-sm font-bold leading-relaxed italic">チェックイン・予約管理・多言語対応をAIが自動化。ホテル業務をまるごとDXします。</p>
                <div className="flex items-center text-emerald-400 font-black text-sm font-semibold">ツールを使う →</div>
              </CardContent>
            </Card>
          </Link>
        </div>
