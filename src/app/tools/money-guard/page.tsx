...
export const metadata = {
  title: 'AI家計防衛シミュレーター | 無駄遣いをAIで心理的に抑止 | NextraLabs',
  description: '購入前の「迷い」をAIが客観的に分析。カメラでレシートや商品画像をスキャンし、心理的な弱点を突いたアドバイスで無駄遣いを未然に防ぎます。',
  keywords: ['家計簿 アプリ', '節約 AI', '無駄遣い 対策', '衝動買い 抑止', 'Money Guard'],
}
    ...
    <div className="min-h-screen bg-[#050507] text-slate-200 font-sans pb-32">
      ...
      <section className="bg-[#13141f] py-24 border-y border-white/5">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 text-left">
            <h3 className="text-3xl font-black text-white italic uppercase tracking-tight text-left">その買い物、後悔しませんか？</h3>
      ...
      <section className="max-w-6xl mx-auto px-4 py-32 space-y-20">
        <div className="text-center space-y-4 text-left">
          ...
          <p className="text-slate-500 font-bold uppercase italic text-center text-left">心理学とAIが融合した3つの防衛線</p>
        </div>

        <div className="grid md:grid-cols-3 gap-10 text-left">
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 text-left">
            <div className="w-12 h-12 bg-red-600/10 rounded-xl flex items-center justify-center text-red-500"><Camera /></div>
            <h4 className="text-xl font-black text-white uppercase italic text-left">ビジュアル・スキャン</h4>
            <p className="text-slate-400 text-sm font-bold leading-relaxed text-left text-left pl-0">レシートや商品画像をAIが即座に解析。何にいくら払おうとしているかを視覚的に把握します。</p>
          </div>
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 text-left">
            <div className="w-12 h-12 bg-red-600/10 rounded-xl flex items-center justify-center text-red-500"><Brain /></div>
            <h4 className="text-xl font-black text-white uppercase italic text-left text-left">心理的弱点の特定</h4>
            <p className="text-slate-400 text-sm font-bold leading-relaxed text-left pl-0">「なぜこれを欲しいと思ったのか」という心理的要因をAIが分析。衝動の裏側を言語化します。</p>
          </div>
          <div className="bg-[#13141f] border-2 border-white/5 p-10 rounded-[3rem] space-y-4 text-left text-left">
            <div className="w-12 h-12 bg-red-600/10 rounded-xl flex items-center justify-center text-red-500"><Shield /></div>
            <h4 className="text-xl font-black text-white uppercase italic text-left text-left">強力な抑止アラート</h4>
            <p className="text-slate-400 text-sm font-bold leading-relaxed text-left pl-0">無駄遣いの可能性が高い場合、画面が「警告モード」へ移行。冷静さを取り戻すまで購入を許可しません。</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 text-center">
        <Card className="bg-gradient-to-br from-red-600 to-rose-900 border-0 rounded-[4rem] p-12 md:p-20 shadow-2xl relative overflow-hidden text-center space-y-10">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-red-100 text-lg font-bold leading-relaxed max-w-2xl mx-auto">
