...
export async function POST(req: Request) {
  ...
  try {
    ...
    const targets = [
      { url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${apiKey}`, name: "1.5-Flash-Beta" },
      { url: `https://generativelanguage.googleapis.com/v1/models/gemini-2.0-flash:generateContent?key=${apiKey}`, name: "1.5-Flash-V1" },
