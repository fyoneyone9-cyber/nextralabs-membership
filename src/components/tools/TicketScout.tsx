  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-10 space-y-12 min-h-screen text-slate-200 font-sans">
      <div className="text-center space-y-4 mb-12">
        ...
        <h1 className="text-5xl font-black text-white uppercase italic tracking-tighter">Ticket Scout</h1>
      </div>
      <div className="max-w-4xl mx-auto bg-indigo-600 p-10 rounded-[3rem] text-white shadow-2xl mb-12 relative overflow-hidden">
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-xl md:text-2xl font-bold leading-relaxed opacity-95">Ticket Scoutの最強プロンプトを現在構築しています。</p>
        </div>
      </div>
