        ...
        {favoriteTools.length > 0 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-top-4">
            <div className="flex items-center gap-3 px-4">
               ...
               <h3 className="font-black italic uppercase tracking-tighter text-2xl">お気に入りシステム</h3>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-80">
          <Card className="bg-[#13141f] border-2 border-white/5 rounded-[2rem] shadow-xl overflow-hidden group">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">利用可能プラン</CardTitle>
