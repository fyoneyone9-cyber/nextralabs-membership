...
const ALL_TOOLS = [
  { id: 'staysee-ai-finder', name: 'AIﾃ励・繝・ΝDX繧ｷ繧ｹ繝・Β縲侵extra縲・, icon: Building2, color: 'text-emerald-500', bg: 'bg-emerald-500/10', plan: 'premium' },
  ...
  { id: 'office-politics-graph', name: '遉ｾ蜀・帆豐ｻ AI逶ｸ髢｢蝗ｳ', icon: Share2, color: 'text-slate-400', bg: 'bg-slate-400/10', plan: 'free' },
  { id: 'trend-stock', name: 'SNS繝医Ξ繝ｳ繝芽・蜍穂ｻ募・', icon: TrendingUp, color: 'text-orange-500', bg: 'bg-orange-500/10', plan: 'standard' },
]
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-80">
          ...
          <Card className="bg-[#13141f] border-2 border-white/5 rounded-[2rem] shadow-xl overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">繝ｭ繧ｰ繧､繝ｳ繧｢繧ｫ繧ｦ繝ｳ繝・/CardTitle>
