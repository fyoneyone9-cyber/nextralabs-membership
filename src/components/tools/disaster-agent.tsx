...
export default function disaster-agent() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-10 space-y-16 min-h-screen text-slate-200 font-sans pb-20">
      <div className="text-center">
        <h1 className="text-5xl md:text-7xl font-bold text-white uppercase tracking-tighter">disaster-agent</h1>
      </div>
      ...
      <DebugPanel data={null} toolId="disaster-agent" />
    </div>
  )
}
