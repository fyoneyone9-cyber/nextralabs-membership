...
const MasterEngine = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-10 space-y-10 min-h-screen text-slate-200 bg-[#050507]">
      ...
      <Card className="bg-[#13141f] p-10 text-center">
        ...
        <h3 className="text-3xl text-white font-bold mb-6 uppercase text-center">周辺宿の販売価格をAIが24時間監視</h3>
        <p className="text-slate-400 max-w-xl mx-auto text-center">楽天市場や宿泊予約サイトから競合の価格をリアルタイム収集。NextraLabsのAIが最適な販売価格を戦略的に提案します。</p>
        <button className="mt-10 h-12 px-12 bg-emerald-600 text-white font-bold rounded-2xl shadow-xl hover:bg-emerald-500 transition-all uppercase ">監視プロトコルを始動 ➔</button>
      </Card>
    </div>
  );
};
