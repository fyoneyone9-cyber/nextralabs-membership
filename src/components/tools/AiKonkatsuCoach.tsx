  ...
  return (
    <div className="max-w-7xl mx-auto p-10 space-y-16 min-h-screen text-slate-200 font-sans pb-40">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-white uppercase italic tracking-tighter">AI婚活コーチ</h1>
      </div>
      <div className="max-w-4xl mx-auto bg-indigo-600 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden text-left">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-3xl font-black italic uppercase">プロフィール添削</h3>
          </div>
          <p className="text-2xl font-bold leading-relaxed opacity-95">自己紹介文を貼り付けてください。</p>
      ...
      <DebugPanel data={null} toolId="aikonkatsucoach" />
    </div>
  )
}