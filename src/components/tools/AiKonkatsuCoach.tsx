...
const WEAPONS = [
  { 
    id: 'strategy', 
    label: '心理×AI婚活戦略', 
    desc: '上級心理カウンセラーの知見を統合', 
    icon: Flame, 
    color: 'text-rose-400', 
    bg: 'bg-rose-400/10',
    prompt: "あなたは「マリッジロードジャパン」を運営する上級心理カウンセラー・婚活コンサルタントです。単なるマッチングのアドバイスではなく、人間の深層心理（承認欲求、愛着スタイル、心理的安全性など）を解析し、相談者が『選ばれる』ための具体的かつ本質的なアクションプランを提案してください。",
    presets: [
      { label: "深層心理から選ばれる理由を作る", content: "【30代・男性】自分に自信がなく、お見合いで相手の顔色を伺いすぎてしまう。上級心理カウンセラーの視点から、相手の「無意識の不安」を取り除き、圧倒的な安心感を与える振る舞いを教えて。" },
      { label: "自己肯定感の再構築", content: "婚活が長引き、自分には価値がないと感じ始めている。心理学のワークを用いて、自分の本来の魅力を再発見し、相手に『余裕のある大人』として認識させるためのマインドセットを構築して。" },
      { label: "相手の愛着スタイルを見抜く", content: "交際相手が急に距離を置いたり、逆に依存してきたりする。相手の言動から「愛着スタイル」を分析し、長く良好な関係を築くための最適なコミュニケーション方法を伝授して。" },
      { label: "沈黙を「親密度」に変える心理術", content: "デート中の沈黙が怖くて話しすぎてしまう。心理学的に『沈黙』をどう活用すれば相手の心を開き、特別な存在として意識させることができるか、具体的なステップを教えて。" }
    ]
  },
  { 
    id: 'diagnosis', 
