...
const TABS = [
  { id: 'scan', label: '① 繧ｹ繧ｭ繝｣繝ｳ', icon: Camera },
  { id: 'match', label: '② 辣ｧ蜷医・繝ｭ繝輔ぃ繧､繝ｫ', icon: UserCheck },
  { id: 'lock', label: '③ 骰ｵ閾ｪ蜍慕匱陦・, icon: Lock },
  { id: 'monetize', label: '④ 蜿守寢蛹・, icon: Coins },
  { id: 'insights', label: '⑤ 繝ｬ繝昴・繝・, icon: Building2 },
];
  ...
  return (
    <div className="max-w-7xl mx-auto p-3 md:p-10 space-y-8 min-h-screen text-slate-200 font-sans pb-20 bg-[#050507] border-4 md:border-8 border-emerald-500/50 rounded-[2rem] md:rounded-[4rem] my-2 md:my-4 shadow-[0_0_100px_rgba(16,185,129,0.2)] print:border-0 print:shadow-none print:my-0 print:p-0">
      <div className="text-center space-y-2 print:hidden">
        ...
        <h1 className="text-3xl md:text-6xl font-black text-white uppercase italic tracking-tighter drop-shadow-xl leading-none">AIﾃ励・繝・ΝDX繧ｷ繧ｹ繝・Β縲侵extra縲・/h1>
      ...
      <div className="mt-4 text-left">
        {showSettings ? (
          ...
          <Card className="bg-[#13141f] border-2 border-white/5 rounded-[2.5rem] p-8 md:p-16 shadow-2xl animate-in fade-in text-center print:hidden">
            <h3 className="text-2xl md:text-4xl font-black text-white italic uppercase mb-10 flex items-center justify-center gap-4 text-emerald-400"><PackageSearch /> ① 諡ｾ蠕礼黄繧ｹ繧ｭ繝｣繝ｳ</h3>
