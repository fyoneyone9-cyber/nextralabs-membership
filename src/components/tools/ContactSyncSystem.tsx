...
const MasterEngine = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-3 md:p-10 space-y-6 md:space-y-10 min-h-screen text-slate-200 font-sans pb-10 bg-[#050507] text-left border-4 md: rounded-[2rem] md:rounded-[4rem] my-2 md:my-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <button 
              ...
              className={`w-full h-32 ${isProcessing ? 'bg-slate-800' : 'bg-emerald-600 hover:bg-emerald-500'} text-white font-bold rounded-[2rem] shadow-2xl flex flex-col items-center justify-center gap-2 transition-all active:scale-95 border-b-8 border-blue-900 active:border-b-0`}
            >
              {isProcessing ? (
      ...
      <div className="bg-emerald-600/5 border-2 border-emerald-500/20 rounded-[2.5rem] p-8 space-y-4 shadow-inner text-left">
