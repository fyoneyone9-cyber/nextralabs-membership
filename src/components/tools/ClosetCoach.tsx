  ...
  return (
    <div className="max-w-6xl mx-auto p-10 space-y-12 min-h-screen text-slate-200 font-sans">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-5xl font-black text-white uppercase italic tracking-tighter">クローゼット断捨離</h1>
      </div>
      <div className="max-w-4xl mx-auto bg-indigo-600 p-10 rounded-[3rem] text-white shadow-2xl mb-12">
        ...
        <p className="text-xl md:text-2xl font-bold leading-relaxed opacity-95">クローゼット断捨離の機能を、最高の使い心地で準備しています。</p>
      </div>
      ...
      <DebugPanel data={null} toolId="closetcoach.tsx" />
    </div>
  )
}