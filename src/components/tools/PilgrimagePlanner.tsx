...
const PRESETS = [
  ...
  { id: 'fma',         label: '鋼の錬金術師',  emoji: '⚗️', color: 'border-yellow-500/60 hover:border-yellow-400' },
  { id: 'cowboy',      label: 'カウボーイビバップ', emoji: '🎺', color: 'border-yellow-500/60 hover:border-yellow-400' },
  { id: 'akira',       label: 'AKIRA',         emoji: '🏍️', color: 'border-red-500/60 hover:border-red-400' },
  { id: 'sailormoon',  label: 'セーラームーン',  emoji: '🌙', color: 'border-pink-500/60 hover:border-pink-400' },
  { id: 'dragonquest', label: 'ドラクエの里',    emoji: '🐉', color: 'border-green-500/60 hover:border-green-400' },
  { id: 'mononoke',    label: 'もののけ姫',      emoji: '🦌', color: 'border-green-500/60 hover:border-green-400' },
  { id: 'howl',        label: 'ハウルの城',      emoji: '🏰', color: 'border-blue-500/60 hover:border-blue-400' },
  { id: 'nausicaa',    label: 'ナウシカ',        emoji: '🌿', color: 'border-emerald-500/60 hover:border-emerald-400' },
  { id: 'laputa',      label: 'ラピュタ',        emoji: '⚙️', color: 'border-sky-500/60 hover:border-sky-400' },
  { id: 'ghost',       label: '攻殻機動隊',      emoji: '🤖', color: 'border-cyan-500/60 hover:border-cyan-400' },
  { id: 'lotgh',       label: '銀河英雄伝説',    emoji: '🚀', color: 'border-yellow-500/60 hover:border-yellow-400' },
  { id: 'vinland',     label: 'ヴィンランドサガ', emoji: '⚔️', color: 'border-gray-500/60 hover:border-gray-400' },
  { id: 'jojo',        label: 'ジョジョ',        emoji: '💎', color: 'border-purple-500/60 hover:border-purple-400' },
  { id: 'rezero',      label: 'Re:ゼロ',        emoji: '🔮', color: 'border-blue-500/60 hover:border-blue-400' },
  { id: 'maid',        label: 'メイドインアビス', emoji: '🕳️', color: 'border-indigo-500/60 hover:border-indigo-400' },
  { id: 'violet',      label: 'ヴァイオレットエバーガーデン', emoji: '✉️', color: 'border-blue-500/60 hover:border-blue-400' },
  { id: 'lwa',         label: 'リトルウィッチアカデミア', emoji: '🧙', color: 'border-purple-500/60 hover:border-purple-400' },
  { id: 'gridman',     label: 'グリッドマン',    emoji: '⚡', color: 'border-red-500/60 hover:border-red-400' },
  { id: 'koe',         label: '聲の形',          emoji: '🎵', color: 'border-cyan-500/60 hover:border-cyan-400' },
  { id: 'anohana',     label: 'あの花',          emoji: '🌸', color: 'border-pink-500/60 hover:border-pink-400' },
]
